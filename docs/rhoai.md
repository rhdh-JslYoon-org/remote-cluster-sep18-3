...
3) Access the `workbench` named `remote-cluster-sep18-3-notebook`.
...
5) In the terminal, run `cd remote-cluster-sep18-3` to navigate to your sample app's directory.
