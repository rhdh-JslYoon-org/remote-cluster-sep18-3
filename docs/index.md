...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep18-3](https://github.com/rhdh-JslYoon-org/remote-cluster-sep18-3)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/remote-cluster-sep18-3-gitops](https://github.com/rhdh-JslYoon-org/remote-cluster-sep18-3-gitops)

# **Usage**

To access the remote-cluster-sep18-3 application that was deployed using the Software Template, complete the following instructions:
